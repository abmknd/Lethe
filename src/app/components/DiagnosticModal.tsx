...
// Single source of truth. This file used to carry its own copy of the
// questions, the scoring tables and the result matrix; the rebrand shell had a
// second copy, and the two could drift without anything failing. Both now read
// from here. See scripts/verify-diagnostic.mjs, which fails the build if these
// declarations reappear locally.
import {
  PROGRESS,
  QUESTIONS,
  TEASER,
