    ...
    >
      <div className="flex flex-col gap-[24px] pb-[8px]">
        <div className="flex items-center justify-between">
          <TitlePill surface={surface}>HOW IT WORKS</TitlePill>
          <DescriptivePill surface={surface}>{step}</DescriptivePill>
        </div>

        <div className="flex flex-col gap-[12px]">
          <p className="rebrand-display text-[clamp(26px,3.5vw,40px)] font-normal leading-none">{title}</p>
          <p className="text-[16px] font-normal leading-[1.2]">{body}</p>
        </div>
      </div>
