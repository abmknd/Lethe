/**
 * home-03 — GENERATED from Figma node 671:1174. Do not edit.
 *
 * The Symbols component's icon type. Figma description: house. NOT home-01, which is the feed sidebar's.
 *
 * Regenerate: node scripts/import-figma-icons.mjs
 */
export function Home03Icon({ size = 16, strokeWidth, className }: {
  size?: number;
  strokeWidth?: number;
  className?: string;
}) {
