...
function isSchemaCompatible(db) {
  const requirements = {
    ...
    preferences: ['id', 'offers', 'asks', 'preferred_locations', 'user_type', 'preferred_user_types', 'objectives', 'languages', 'meeting_frequency', 'learn_about', 'ask_about', 'who_to_meet', 'notification_prefs', 'company_name', 'work_email', 'linkedin_url', 'company_stage', 'meet_stages', 'not_looking_for'],
